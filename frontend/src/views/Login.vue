<template>
  <div>
    ...
    <div class="login border rounded shadow-sm bg-light">
      ...
      <p class="subtitle" v-if="mode == 'connexion'">
        Vous n'avez pas encore de compte ?
        <span class="card__action"
          ><router-link to="/login?mode=inscription"
      ...
      <p class="subtitle" v-else>
        ...
        <span class="card__action"
          ><router-link to="/login?mode=connexion"
      ...
      <form method="post" id="formulaire">
        <div class="rowForm" v-if="mode == 'inscription'">
          ...
          <input
            ...
            type="text"
            pattern="[A-Za-z]+"
            title="caractères alphabétiques uniquement"
            placeholder="Nom"
          />
        </div>
        <div class="rowForm" v-if="mode == 'inscription'">
        ...
        <div class="rowForm" v-if="mode == 'inscription'">
          ...
          <input
            v-model="userInfos.confirmPassword"
            required
            id="confirmPassword"
            class="formInput"
            type="password"
